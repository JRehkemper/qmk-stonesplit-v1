...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
      ...
      KC_LEFT,          _______,          KC_RIGHT_CTRL,    _______,          KC_RIGHT_ALT,     _______,          _______,          KC_SPACE,         KC_DOWN,                      KC_LCTL,    KC_ESC,     KC_LEFT_GUI,    KC_LEFT_ALT,    KC_BACKSPACE,   _______,    _______,    KC_LSFT,     _______
      )
};